...
function LookupContent() {
  ...
  return (
    <div className="mx-auto max-w-5xl">
      ...
      <div className="grid overflow-hidden border border-[#cfdee3] bg-white shadow-[0_24px_70px_rgba(21,36,43,0.09)] lg:grid-cols-[0.8fr_1.2fr]">
        <aside className="relative overflow-hidden bg-[#153b4d] p-6 text-white sm:p-9">
          <div
            aria-hidden="true"
            className="absolute -bottom-24 -left-24 size-64 rounded-full border-[42px] border-[#2480a8]/35"
          />
          <p className="relative text-[0.7rem] font-black uppercase tracking-[0.17em] text-[#9fc7d6]">
            Family equipment lookup
          </p>
        ...
        <div className="p-5 sm:p-9">
          <div className="border-b border-[#dce7eb] pb-6">
          ...
          <form onSubmit={performSearch} className="mt-6">
            ...
            {lookupError ? (
              <p
                role="alert"
                className="mt-3 border-l-4 border-[#b42332] bg-[#fbedef] px-3 py-2 text-sm font-medium text-[#8e2635]"
              >
                {lookupError}
              </p>
            ) : null}
            ...
            <Button
              type="submit"
              size="lg"
              className="mt-5 h-12 w-full rounded-full bg-[#751c2b] text-white hover:bg-[#59141f]"
          ...
          {loading ? (
            <div className="mt-8 space-y-3 border-t border-[#dce7eb] pt-7">
          ...
          {!loading && searched && !result ? (
            <div className="mt-8 border-t border-[#dce7eb] pt-8 text-center">
              <span className="mx-auto flex size-12 items-center justify-center rounded-full bg-[#e6f0f4] text-[#153b4d]">
                <PackageSearch className="size-5" />
              </span>
              <h3 className="mt-4 text-lg font-extrabold text-[#15242b]">
                No matching registration
              </h3>
              <p className="mx-auto mt-2 max-w-sm text-sm leading-6 text-[#5d7078]">
          ...
          {!loading && result ? (
            <div className="mt-8 border-t border-[#dce7eb] pt-7">
              <div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-end">
                <div>
                  <p className="text-[0.68rem] font-black uppercase tracking-[0.14em] text-[#2e7c60]">
                    Registration matched
                  </p>
                  <h3 className="mt-1 text-2xl font-extrabold tracking-[-0.03em] text-[#15242b]">
                    {result.name}
                  </h3>
                  {result.shoeSize ? (
              ...
              {result.checkouts.length === 0 ? (
                <div className="mt-5 border border-[#cfdee3] bg-[#f7fafb] px-5 py-7 text-center">
                  <p className="font-extrabold text-[#15242b]">
                ...
                <div className="mt-5 divide-y divide-[#dce7eb] border border-[#cfdee3]">
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-4">
                          <span className="flex size-11 shrink-0 items-center justify-center rounded-full bg-[#e6f0f4] text-[#153b4d]">
                            <Icon className="size-5" />
                          </span>
                          <div>
                            <h4 className="font-extrabold capitalize text-[#15242b]">
                            ...
                            {checkout.equipmentBrand ? (
                              <p className="mt-0.5 text-sm text-[#5d7078]">
                                {checkout.equipmentBrand}
                              </p>
                            ) : null}
                          </div>
                        </div>
                        <div className="flex items-center gap-2 pl-[3.75rem] text-xs font-semibold text-[#5d7078] sm:pl-0">
              ...
              <p className="mt-4 text-xs leading-5 text-[#75868d]">
